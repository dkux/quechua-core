...
public class CursoResourceIntTest {
    ...
    private static final CursoEstado DEFAULT_ESTADO = CursoEstado.ACTIVO;
    private static final CursoEstado UPDATED_ESTADO = CursoEstado.INACTIVO;
    ...
    public void setup() {
        ...
        final CursoResource cursoResource = new CursoResource(cursoService, coloquioService);
    ...
    @Test
    @Transactional
    public void checkVacantesIsRequired() throws Exception {
        int databaseSizeBeforeTest = cursoRepository.findAll().size();
        // set the field null
        curso.setVacantes(null);
