...
INSERT INTO `cursada` (`id`, `nota_cursada`, `libro`, `folio`, `estado`, `nota_final`, `curso_id`, `alumno_id`, `periodo_id`)
VALUES
  (1, NULL, NULL, NULL, 'FINAL_PENDIENTE', NULL, 1, 7, 1),
  (2, NULL, NULL, NULL, 'FINAL_PENDIENTE', NULL, 2, 7, 1),
  (3, NULL, NULL, NULL, 'ACTIVA', NULL, 3, 7, 1);
...
VALUES
  ...
  (2, '201', '19:00', '22:00', 'PC', '2018-12-30', 1, 1, 'ACTIVO'),
  (3, '201', '19:00', '22:00', 'PC', '2018-12-16', 1, 1, 'ACTIVO'),
  (4, 'E9', '9:00', '12:00', 'PC', '2018-12-18', 2, 1, 'ACTIVO');

INSERT INTO `inscripcion_coloquio` (`id`, `estado`, `coloquio_id`, `alumno_id`, `cursada_id`)
VALUES
  (1, 'ACTIVA', 1, 7, 1),
  (2, 'ACTIVA', 3, 7, 1),
  (3, 'ACTIVA', 4, 7, 1);
...
VALUES
  (1, '2018-07-01', '2018-11-12', 'INSCRIPCION_CURSADA'),
  (2, '2018-07-01', '2018-12-31', 'CONSULTAR_PRIORIDAD'),
  (3, '2018-07-01', '2018-12-31', 'INSCRIPCION_COLOQUIO'),
  (4, '2018-11-13', '2018-11-20', 'DESINSCRIPCION_CURSADA'),
  (5, '2018-07-01', '2018-12-31', 'CREACION_COLOQUIO');
