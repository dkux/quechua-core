...
export class AlumnoCarreraDeleteDialog extends React.Component<IAlumnoCarreraDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.alumnoCarreraEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody>Are you sure you want to delete this AlumnoCarrera?</ModalBody>
        <ModalFooter>
