...
export class PeriodoAdministrativoDeleteDialog extends React.Component<IPeriodoAdministrativoDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.periodoAdministrativoEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody>Are you sure you want to delete this PeriodoAdministrativo?</ModalBody>
        <ModalFooter>
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(PeriodoAdministrativoDeleteDialog);
