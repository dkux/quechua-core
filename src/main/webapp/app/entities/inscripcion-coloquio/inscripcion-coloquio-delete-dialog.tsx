...
export class InscripcionColoquioDeleteDialog extends React.Component<IInscripcionColoquioDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.inscripcionColoquioEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody>Are you sure you want to delete this InscripcionColoquio?</ModalBody>
        <ModalFooter>
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(InscripcionColoquioDeleteDialog);
